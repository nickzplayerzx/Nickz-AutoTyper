(function () {
    ...
    const css = `
        :root {
            ...
            --rb-primary: #8a2be2; --rb-primary-hover: #6a1cb0; /* Roxo KhanScript */
            --rb-text: #e4e4e7; --rb-muted: #a1a1aa; --rb-danger: #ef4444;
            --rb-font: 'Inter', sans-serif;
            --rb-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.5);

            /* Modo Claro (descomente para ativar) */
            /*
            --rb-bg: #ffffff; --rb-surface: #f8fafc; --rb-border: #cbd5e1;
            --rb-primary: #7c3aed; --rb-primary-hover: #6d28d9;
            --rb-text: #0f172a; --rb-muted: #64748b; --rb-danger: #dc2626;
            */
        }
        ...
        .rb-minimized-bubble {
            ...
            cursor: pointer; box-shadow: 0 0 15px rgba(138, 43, 226, 0.4); /* Roxo KhanScript */
        ...
        .rb-highlighter {
            ...
            background: rgba(138, 43, 226, 0.1); /* Roxo KhanScript */ z-index: 999990;
        }
            ...
            this.ui.innerHTML = `
                <div class="rb-header">
                    <div style="display:flex; align-items:center; pointer-events:none;">
                        <span class="rb-title">KHANSCRIPT</span> ${fieldBadge}
                    </div>
                ...
                <div class="rb-footer">feito por <a href="https://github.com/nickzplayerzx">@nickzplayerzx</a></div>
            `;
