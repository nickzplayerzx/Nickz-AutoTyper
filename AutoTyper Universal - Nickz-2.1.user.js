...
// @name         AutoTyper Universal - Nickz

// @namespace    https://github.com/nickz

// @version      2.1

// @description  Menu elegante para digitação automática em qualquer site. Créditos: Nickz (Yudi Matheus).

// @author       Nickz (Yudi Matheus)
...
(function () {
  ...
  // Estilo do modal (dark mode + roxo elegante)
  ...
  // === Função: Digitar texto com eventos realistas ===
  ...
  // Encontrar campo de texto mais provável
  ...
  function encontrarCampo() {
    ...
    // Priorizar campos com palavras-chave
